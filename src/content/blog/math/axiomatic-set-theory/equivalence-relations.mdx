...
Một quan hệ $R$ là một tập hợp con của một tích Cartesian $A\times B$ nào đó.
Khi đó ta biểu diễn $R$ bằng một ánh xạ $c_R: A\times B\to \mathbf{T}$ và ta có thể áp dụng [định lý 4](#theorem-4) để nhận được một quan hệ tương ứng trên tập thương.